...
<button className= 'ten'name='/'onClick={handleOnClick}>/</button >
</div>
<div className='div2'>
...
<div className='div4'>
<button className='zero'name='.'onClick={handleOnClick}>.</button >
<button className='dot'name='0'onClick={handleOnClick}>0</button >
